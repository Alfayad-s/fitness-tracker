...
/** Space between fixed chrome (header / streak) and scrollable page content */
export const MOBILE_CONTENT_BELOW_CHROME_GAP = "0.25rem";
...
export const mobileHeaderContentPaddingTop = `calc(env(safe-area-inset-top, 0px) + ${MOBILE_HEADER_BAR_HEIGHT} + ${MOBILE_HEADER_BORDER} + ${STREAK_BELOW_HEADER_GAP} + ${STREAK_CAPSULE_HEIGHT} + ${MOBILE_CONTENT_BELOW_CHROME_GAP})`;

/** Main content padding when only streak pin is visible */
export const mobileStreakPinContentPaddingTop = `calc(env(safe-area-inset-top, 0px) + ${STREAK_PINNED_FROM_TOP} + ${STREAK_CAPSULE_HEIGHT} + ${MOBILE_CONTENT_BELOW_CHROME_GAP})`;

/** Main content padding when header is visible without streak pin */
export const mobileHeaderOnlyPaddingTop = `calc(env(safe-area-inset-top, 0px) + ${MOBILE_HEADER_BAR_HEIGHT} + ${MOBILE_HEADER_BORDER} + ${MOBILE_CONTENT_BELOW_CHROME_GAP})`;
